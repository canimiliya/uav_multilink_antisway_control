...
|---|---|---|
| PID | Cascaded task PID with equilibrium anchoring and bounded correction | `CascadedTaskPID` / `hybrid_x007_y041_z041` |
| Full-State LQR | Full-state linear feedback over UAV and five-link states | `FullStateLQR` / `full_lqr_048` |
